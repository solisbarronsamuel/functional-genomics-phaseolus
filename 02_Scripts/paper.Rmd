...
# chunk at line 44–46
knitr::include_graphics("../03_Results/figures/16S/lecturas-16S.png")

# chunk at line 48–50
knitr::include_graphics("../03_Results/figures/ITS/lecturas-ITS.png")
```

La diversidad alfa del bacterioma indica el índice de Shannon que la mayoría de las muestras presenta diversidad. El InvSimpson resultó que no hay dominancia de especies.

La diversidad alfa en el fungoma, el índice de Shannon la mayoría de las muestras tienen una diversidad moderada con uniformidad de muestras. El InvSimpson la mayoría de las muestras tiene una comunidad equitativa.

```{r, echo=FALSE, out.width="60%"}
# chunk at line 44–46
knitr::include_graphics("../03_Results/figures/16S/diversidad-alfa-16S.png")

# chunk at line 48–50
knitr::include_graphics("../03_Results/figures/ITS/diversidad-alfa-ITS.png")
```

El PCoA 16S la mayoría de las muestras, su comunidad es homogénea y la varianza explicada es del 28.3%. El PCoA ITS las muestras presentan una dispersión, reduciendo su homogeneidad entre las muestras y la varianza explicada fue de 29.2%.

```{r, echo=FALSE, out.width="60%"}
# chunk at line 44–46
knitr::include_graphics("../03_Results/figures/16S/pcoa-16S.png")

# chunk at line 48–50
knitr::include_graphics("../03_Results/figures/ITS/pcoa-ITS.png")
```

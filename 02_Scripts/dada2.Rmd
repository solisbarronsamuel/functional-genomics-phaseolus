...
load("01_RawData/silva/UNITE_publicSH_fungi_04.04.2024.RData")  # carga objeto: trainingSet
...
```{r save-phyloseq-raw}
saveRDS(ps16S, "03_Results/rds/16S/ps16S_raw.RDS")
# saveRDS(ps_ITS, "03_Results/rds/ITS/psITS_raw.RDS")
```
...
ggplot(df_reads, aes(x = reorder(Sample, TotalReads), y = TotalReads)) +
  geom_bar(stat = "identity", fill = "#377eb8") +
  coord_flip() +
  scale_y_continuous(labels = comma) +
  labs(title = "Total de Lecturas por Muestra (16S)",
       x = "Muestra", y = "Número de lecturas") +
